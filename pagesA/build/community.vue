<template>
	<view class="container">
		...
		<view class="MP-search" @click="search()" style="" >
			<input class="MP-search-input" type="text" disabled="true" placeholder="输入关键字搜索" />
		</view>
		<!-- #endif -->
		...
		<!-- #endif -->
			...
			<view class="f-header m-t" @click="navToTabPage('../../pagesA/build/communityList')">
			...
			<!-- 新品上市 -->
        		...
        		<view class="guess-section">
        			<view v-for="(item, index) in newProductList" :key="index" class="guess-item" @click="navToDetailPage(item)">
        				...
        				<text class="price">{{ item.floorNum }}</text>
        			</view>
        		</view>
	</view>
	</view>
