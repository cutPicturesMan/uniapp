			...
			<view class="user-info-box">
				<view class="member-top-c">
					<!-- <view class="portrait-box">
            					<image class="portrait" :src="userDetailInfo.icon || '/static/missing-face.png'" v-if="userDetailInfo"></image>
            					<image class="portrait" src="/static/missing-face.png" v-else></image>
            				</view>
            				<view class="info-box">
            					<text class="username" v-if="userDetailInfo">{{userDetailInfo.nickname }}</text>
					...
					<template v-if="hasLogin">
						<view class="" style="display: flex;align-items: center;" @click="toUserInfo">
							...
							<view class="user-name" style="margin-left: 10upx;color: #FFFFFF;">{{ userDetailInfo.nickname || userDetailInfo.username }}</view>
						</view>
					</template>
					<template v-else>
						<!-- #ifdef H5 || APP-PLUS -->
						...
						<!-- #endif -->
						<!-- #ifdef MP-WEIXIN -->
						<view class="" style="display: flex;align-items: center;" @click="toWeChatLogin">
							<image class="portrait" mode="aspectFill" src="/static/missing-face.png"></image>
							<text class="" style="margin-left: 10upx;color: #FFFFFF;">登录/注册</text>
						</view>
						<!-- <view class="portrait"><open-data type="userAvatarUrl"></open-data></view> -->
						<!-- <view><button class="login-btn" open-type="getUserInfo" @getuserinfo="getWxCode" hover-class="btn-hover">授权登录</button></view> -->
						<!-- #endif -->
						<!-- #ifdef MP-ALIPAY -->
		...
		<view class="cover-container" :style="[
		 ...
		 @touchstart="coverTouchstart" @touchmove="coverTouchmove" @touchend="coverTouchend">
			...
			<view class="history-section icon">
				...
				<!--暂时隐藏-->
				<list-cell icon="icon-userJoin cgtt" iconColor="#0e68d7" v-if="!userDetailInfo.roomNums && false" title="绑定社区"
				 @eventClick="navTo('../../pagesA/build/bindCommunity')"></list-cell>
				<!--暂时隐藏-->
				<list-cell icon="icon-userJoin cgtt" iconColor="#0e68d7" v-if="userDetailInfo.roomNums && false" title="社区主页"
